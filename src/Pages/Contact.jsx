...
function Contact() {
  return (
    ...
    <img class="h-[300px] w-[340px] object-cover animate-zoom-infinite" src="https://img.freepik.com/free-photo/standard-quality-control-concept-m_23-2150041845.jpg?size=626&ext=jpg&uid=R136266302&ga=GA1.1.1882344098.1687350271&semt=ais" alt="Zooming Image"/>
</div>
     <div class="h-[300px] w-[340px] m-auto bg-red-300 overflow-hidden">
    <img class="h-[300px] w-[340px] object-cover animate-zoom-infinite" src="https://img.freepik.com/free-photo/businesswoman-seminar-drawing-graph_53876-101891.jpg?size=626&ext=jpg&uid=R136266302&ga=GA1.1.1882344098.1687350271&semt=ais" alt="Zooming Image"/>
</div>
     <div class="h-[300px] w-[340px] m-auto bg-red-300 overflow-hidden">
    <img class="h-[300px] w-[340px] object-cover animate-zoom-infinite" src="https://img.freepik.com/free-vector/internet-things-smart-wrist-multimedia-watch-gadget-hand_1284-10935.jpg?size=626&ext=jpg&uid=R136266302&ga=GA1.1.1882344098.1687350271&semt=ais"/>
</div>
