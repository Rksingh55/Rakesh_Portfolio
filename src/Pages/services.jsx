  ...
  return (
    <div className="bg-transparent">
      <div className=" text-center p-4 ">
        ...
        <h5>Checkout My Latest Services</h5>

      </div>
      <div  className=" flex md:flex-row max-sm:bg-white flex-wrap md:bg-white md:rounded-[20px] md:px-10 flex-col justify-between md:w-[80%] m-auto w-full ">
        <div  className="flex md:flex-row flex-wrap justify-center  md:gap-2 max-sm:gap-4 mt-5  max-sm:p-6 ">
          <div  className="h-fit  w-full  md:w-[32%] duration-500 hover:-translate-y-2 hover:shadow-xl shadow-gray-800 cursor-pointer bg-blue-400 rounded-md p-6 flex flex-col justify-between">
          ...
          <div  className="h-fit  w-full  md:w-[32%] duration-500 hover:-translate-y-2 hover:shadow-xl shadow-gray-800 cursor-pointer bg-yellow-300 rounded-md p-6 flex flex-col justify-between">
            <div className="text-yellow-500 bg-white rounded-full h-[100px] w-[100px] m-auto">
              <div className="flex items-center justify-center h-full">
          ...
          <div className="h-fit  w-full  md:w-[32%] duration-500 hover:-translate-y-2 hover:shadow-xl shadow-gray-800 cursor-pointer w-[325px] bg-green-300 rounded-md p-6 flex flex-col justify-between">
            <div className="text-yellow-500 bg-white rounded-full h-[100px] w-[100px] m-auto">
              <div className="flex items-center justify-center h-full ">
