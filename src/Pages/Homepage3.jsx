...
import "./home3.css";
import { FaFacebook, FaFacebookSquare, FaLinkedin, FaWhatsapp } from "react-icons/fa";
...
{/* //socialicons */}
          ...
          <Link href="https://wa.me/7310307513"  class="twitter">
            <IoLogoWhatsapp />
          </Link>
          <Link href="https://www.linkedin.com/in/rakesh-singh-154108235/" type="e" class="linkedin">
            <IoLogoGithub />
          </Link>
            ...
            <div className="md:w-[70%] w-[95%] m-auto absolute bg-[#333B50] md:p-[130px] p-[30px]">
              <div className="">
                <div class="flex justify-center items-center">
                  <div class="border-2 hover:bg-[#00d646] w-[80px] flex justify-center items-center h-[80px] rounded-full border-[#00d646] px-8 py-3 text-white font-bold text-4xl mb-12 md:mb-5">
                    R
                  </div>
                </div>
                ...
                <div className="flex justify-center mt-[50px]">
                  ...
                  <a href="/Rakeshupdated9.pdf" download="Rakeshupdated9.pdf" className="text-decoration-none text-[#00d646] hover:text-white">
    Download Resume
  </a>
                  </button>
                </div>
          ...
          <div className="parallax2">
            <div className="  parallax2content ">
              <div className="flex justify-center  items-center text-white h-screen">
                <div className="mt-[300px] flex gap-5  ">
                  <div className="flex justify-center items-center">
    ...
    <img class="h-[300px] w-[340px] object-cover animate-zoom-infinite" src="https://img.freepik.com/free-photo/medium-shot-woman-working-laptop_23-2150323516.jpg?size=626&ext=jpg&uid=R136266302&ga=GA1.1.1882344098.1687350271&semt=sph" alt="Zooming Image"/>
</div>
     <div class="h-[300px] w-[340px] m-auto bg-red-300 overflow-hidden">
    <img class="h-[300px] w-[340px] object-cover animate-zoom-infinite" src="https://img.freepik.com/free-photo/high-angle-man-working-laptop_23-2150287639.jpg?size=626&ext=jpg&uid=R136266302&ga=GA1.1.1882344098.1687350271&semt=sph" alt="Zooming Image"/>
</div>
     <div class="h-[300px] w-[340px] m-auto bg-red-300 overflow-hidden">
    <img class="h-[300px] w-[340px] object-cover animate-zoom-infinite" src="https://img.freepik.com/free-photo/medium-shot-woman-working-computer_23-2150287666.jpg?size=626&ext=jpg&uid=R136266302&ga=GA1.1.1882344098.1687350271&semt=sph"/>
</div>
              ...
              <div>
                ...
                <div className="flex md:flex-row flex-col">
                  <div className="basis-1/2 border-r-[5px]  border-green-400 ">
                    <div className="flex md:flex-row flex-col max-sm:p-3">
                      ...
                      <div className="basis-1/2 ">
                        <div className="md:mr-12 md:mt-[300px] flex flex-col justify-end items-end ">
                          <h5 className="text-[#00d646]">March 2023 - June 2023</h5>
                          <h4 className="text-white">Aqusag Technologies India</h4>
                  ...
                  <div className="basis-1/2  max-sm:p-3 ">
                    <div className="md:w-[40%] w-full md:ml-12 mt-12 text-start">
                ...
                <div className="flex md:flex-row flex-col">
                  ...
                  <div className="basis-1/2  max-sm:p-3 ">
                    <div className="md:w-[40%] w-full md:ml-12 mt-12 text-start">
                      ...
                      <h6 className="text-white">                    Ramjatan Inter College Gorakhpur
</h6>
                      <p className="text-justify">
